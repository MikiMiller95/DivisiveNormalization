...
class SpatialDivisiveBatch(nn.Module):
    """
    AlexNet with Spatial Divisive Normalization and Batch Norm
    """
    def __init__(self, num_classes=100):
        ...
        self.features = nn.Sequential(
            ...
            nn.ReLU(),
            SpatialOnlyDivisiveNorm(xy_lamb=[100.0], alpha=[.1], beta=[1.], k=[1.]),
            nn.BatchNorm2d(256),
    ...
    def init_bias(self):
        for layer in self.features:
            ...
            if isinstance(layer, SpatialOnlyDivisiveNorm):
