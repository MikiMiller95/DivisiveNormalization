...
class DivisiveInstance(nn.Module):
    """
    AlexNet with Divsive and Instance Normalization
    """
    def __init__(self, num_classes=100):
        ...
        self.features = nn.Sequential(
            ...
            nn.ReLU(),
            DivisiveNorm(lamb=[10.], alpha=[.1], beta=[1.], k=[.5]),
            nn.InstanceNorm2d(num_features=64,affine=True),
            nn.MaxPool2d(kernel_size=3, stride=2),  # (b x 96 x 27 x 27)
            nn.Conv2d(64, 192, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.ReLU(),
            DivisiveNorm(lamb=[10.],alpha=[.1], beta=[1.], k=[.5]),
            nn.InstanceNorm2d(num_features=192,affine=True),
            nn.MaxPool2d(kernel_size=3, stride=2),  # (b x 256 x 13 x 13)
            nn.Conv2d(192, 384, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.ReLU(),
            DivisiveNorm(lamb=[2.], alpha=[1.], beta=[1.], k=[1.]),
            nn.InstanceNorm2d(num_features=384,affine=True),
